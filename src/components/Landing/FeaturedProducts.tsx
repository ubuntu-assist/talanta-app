...
import productImg from '../../assets/images/products/linear.webp'
import { WobbleCard } from '../../designSystem/ui/WobbleCard'
        ...
        <div className='py-6 space-y-4 md:space-y-6'>
          <div className=''>
            ...
            <h2 className='text-xl md:text-4xl text-gray-900 font-semibold mb-3'>
              We&#x27;re more than a coding platform!
            </h2>
            <p className='md:text-lg max-w-2xl text-gray-700'>
              From software tools to premium resources, find solutions to
              enhance productivity and drive success.
            </p>
          </div>
        </div>
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-[1400px] mx-auto w-full'>
          <WobbleCard
