              ...
              <div className='flex flex-col items-start lg:pr-16'>
                <div className='w-16'>
                  ...
                  >
                    ...
                    <path
                      fill='url(#SVGID_1_)'
                      d='M404,215.8v94.4c0,8.5-1.2,16.9-3.7,25l-23.9,118.4H197.5c0,0-10.7-11.5-25.9-28.3        c-15.5-17.2-3.4-44.7,19.7-44.7h60.3c38.3,0,69.3-31.2,69.3-69.7V182c0-7.5,6.8-13.1,14.1-11.6l32.6,6.6        C396.4,184,404,205.4,404,215.8z'
                    ></path>
                    <path d='M197.5,460c-2.1,0-4.3-0.9-5.8-2.5c-0.3-0.4-33.2-35.6-65.7-72.6c-67.5-77-67.5-86.4-67.5-91.4c0-19.2,9-30.4,16.6-36.5        c8.4-6.7,19.5-10.5,30.3-10.5c2.6,0,5.2,0.5,7.7,1.4c14.6,5.8,23.8,13.5,36.4,24.2c3.9,3.3,8.1,6.8,12.9,10.7V86        c0-10.9,3.8-22,10.5-30.4c6-7.6,17.2-16.8,36.5-16.8c19.2,0,30.4,9,36.5,16.6c6.7,8.4,10.5,19.5,10.5,30.3v60.7l97.3,19.5        c0.1,0,0.2,0,0.3,0.1l15.3,3.1c0.1,0,0.2,0,0.3,0.1c33.7,8.2,42.6,34,42.6,46.5v93.8c0,9.1-1.3,18.1-3.9,26.8l-23.8,117.4        c-0.8,3.7-4,6.4-7.8,6.4H235.2c-4.4,0-8-3.6-8-8s3.6-8,8-8h134.7l22.6-111.3c0-0.2,0.1-0.5,0.2-0.7c2.2-7.3,3.3-14.9,3.3-22.6v-93.8        c0-8.1-6.3-25-30.2-30.9l-5.7-1.1v45c0,4.4-3.6,8-8,8s-8-3.6-8-8v-48.2l-35.9-7.2v65.4c0,4.4-3.6,8-8,8s-8-3.6-8-8v-68.6l-35.9-7.2        v85.8c0,4.4-3.6,8-8,8s-8-3.6-8-8V85.7c0-10.7-6.5-30.9-30.9-30.9S178.3,75.2,178.3,86v213.1c0,3-1.7,5.8-4.4,7.2        c-2.7,1.4-5.9,1.1-8.4-0.7c-11.1-8.3-19.6-15.5-26.4-21.2c-11.9-10-19.7-16.7-31.9-21.5c-0.6-0.2-1.2-0.3-1.9-0.3        c-10.7,0-30.8,6.4-30.9,30.6c0.8,3.2,8,18,65.3,83.2c31.7,36.1,63.3,69.9,63.6,70.3c3,3.2,2.8,8.3-0.4,11.3        C201.4,459.3,199.4,460,197.5,460z'></path>
                    <g>
                      <path
                        fill='#d500f9'
            ...
            <div className='mt-8 lg:mt-10 lg:w-1/2'>
              <div className='flex flex-col items-start lg:pr-16'>
                ...
                <p className='lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl'>
                  ...
                  ad tenetur sequi exercitationem eveniet.
                </p>
              </div>
            </div>
            <div className='mt-8 lg:mt-10 lg:w-1/2'>
              <div className='flex flex-col items-start lg:pr-16'>
                <div className='w-16'>
                  ...
                  >
                    ...
                    <path
                      fill='url(#SVGID_1_)'
                      d='M45.6,460L280,238.7c11.3-10.6,28.7-11,40.5-1l22.1,18.9l-186,162.7c0,0-67.4,2.7-101,50.6L45.6,460z        '
                    ></path>
              ...
              <div className='flex flex-col items-start lg:pr-16'>
                <div className='w-16'>
                  ...
                  >
                    ...
                    <path
                      fill='url(#SVGID_1_)'
                      d='M496.8,369.7H58.2c-11.6,0-21-9.4-21-21V170.7c0-11.8,9.6-21.4,21.4-21.4h438.1V369.7z'
                    ></path>
                ...
                <p className='lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl'>
                  ...
                  impedit reiciendis optio deleniti odit illum nisi deserunt
                  possimus..
                </p>
              </div>
            </div>
